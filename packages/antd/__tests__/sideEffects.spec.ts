...
test('dist/*', () => {
  ...
  expect(hasSideEffect('dist/antd.css', 'dist/*')).toBeTruthy()
  expect(
    hasSideEffect('dist/formily.antd.umd.development.js', 'dist/*'),
  ).toBeTruthy()
  expect(
    hasSideEffect('dist/formily.antd.umd.production.js', 'dist/*'),
  ).toBeTruthy()
})
...
test('esm/*.js & lib/*.js', () => {
  ...
  expect(hasSideEffect('esm/index.js', 'esm/*.js')).toBeTruthy()
  expect(hasSideEffect('lib/index.js', 'lib/*.js')).toBeTruthy()
  ...
  expect(hasSideEffect('esm/input/index.js', 'esm/*.js')).toBeFalsy()
  expect(hasSideEffect('esm/array-base/index.js', 'esm/*.js')).toBeFalsy()
  expect(hasSideEffect('lib/input/index.js', 'lib/*.js')).toBeFalsy()
})

test('*.less', () => {
  //  eg. import "@next-formily/antd/lib/input/style.less"
  expect(
    hasSideEffect(`${baseName}/lib/input/style.less`, '*.less'),
  ).toBeTruthy()
})
...
test('**/*/style.js', () => {
  ...
  modulePathArr.forEach((modulePath) => {
    const hasSideEffects = hasSideEffect(modulePath, '**/*/style.js')
