...
> This mainly refers to the difference between @next-formily/core
...
> This mainly refers to the difference between @next-formily/react and @next-formily/react-schema-renderer.

**createFormActions/createAsyncFormActions**

- V1 Create a Form operator, you can call the setFieldState/setFormState method.
- V2 is removed, and the operation status of the Form instance created by [createForm](https://core.formilyjs.org/api/entry/create-form) in @next-formily/core is used uniformly.
...
- V2 Remove, export from @next-formily/core uniformly, and will not return RxJS Observable object
...
In Formily 1.x, we mainly use @next-formily/antd and @next-formily/antd-components, or @next-formily/next and @next-formily/next-components.

In V2, we have the following changes:

- @next-formily/antd and @next-formily/antd-components were merged into @next-formily/antd, and the directory structure was changed to that of a pure component library.

- The internal API of @next-formily/react @next-formily/core will no longer be exported.
