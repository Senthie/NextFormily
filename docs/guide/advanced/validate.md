...
Formily's form validation uses the extremely powerful and flexible @next-formily/validator validation engine. There are two main scenarios for validation:
