...
Therefore, we more recommend using [@next-formily/reactive](https://reactive.formilyjs.org) to achieve responsive control, which can achieve both value control and field-level control.
...
Responsive control is mainly to use [@next-formily/reactive](https://reactive.formilyjs.org) to achieve responsive updates, we can easily achieve two-way binding, while the performance is full of normal controlled updates.
...
It is recommended to use [@next-formily/reactive](https://reactive.formilyjs.org) to achieve responsive control.
